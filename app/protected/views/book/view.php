...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <?php if (!Yii::app()->user->isGuest): ?>
        <div>
            ...
            <?= CHtml::link('Удалить', ['delete', 'id' => $model->id], ['class' => 'btn btn-danger', 'confirm' => 'Вы уверены?']) ?>
        </div>
    <?php endif; ?>
</div>
...
<?php if ($model->photo): ?>
    <div class="mb-4">
        <img src="/uploads/<?= CHtml::encode($model->photo) ?>" class="img-thumbnail book-photo" alt="<?= CHtml::encode($model->title) ?>">
    </div>
<?php endif; ?>
